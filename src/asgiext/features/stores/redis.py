...
class RedisStore(NamespacedStore):
    ...
    def __init__(self, redis: Redis[Any], namespace: str | None = None) -> None:
        ...
        Args:
            ...
            namespace: A key prefix to simulate a namespace in redis. If not given,
                defaults to ``asgiext``. Namespacing can be explicitly disabled by passing
    ...
    def with_client(  # noqa: PLR0913
        ...
        *,
        ...
        return cls(redis=Redis(connection_pool=pool), namespace=namespace)  # type: ignore
    ...
    async def get(self, key: str, renew_for: int | timedelta | None = None) -> bytes | None:
        ...
        if renew_for:
            ...
            data = await self._get_and_renew_script(keys=[key], args=[renew_for])  # type: ignore
    ...
    async def expires_in(self, key: str) -> int | None:
        ...
        return None if ttl == -2 else ttl  # noqa: PLR2004
