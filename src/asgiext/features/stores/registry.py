...
def default_default_factory(name: str) -> Store:  # noqa: ARG001
    return MemoryStore()
...
class StoreRegistry:
    ...
    def __init__(
        ...
        Args:
            ...
            default_factory: A callable used by :meth:`StoreRegistry.get` to provide a store,
                if the requested name hasn't
